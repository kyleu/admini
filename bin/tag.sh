...
if [[ $TGT =~ $pat ]]; then
  ...
  sed -i.bak -e "s/\\_[v]*[0-9]*[0-9]\.[0-9]*[0-9]\.[0-9]*[0-9]_/_v${TGT}\\_/g" ./tools/notarize/gon.amd64.hcl
  rm -f "./tools/notarize/gon.amd64.hcl.bak"
  sed -i.bak -e "s/\\_[v]*[0-9]*[0-9]\.[0-9]*[0-9]\.[0-9]*[0-9]_/_v${TGT}\\_/g" ./tools/notarize/gon.arm64.hcl
  rm -f "./tools/notarize/gon.arm64.hcl.bak"
  sed -i.bak -e "s/\\_[v]*[0-9]*[0-9]\.[0-9]*[0-9]\.[0-9]*[0-9]_/_v${TGT}\\_/g" ./tools/notarize/gon.all.hcl
