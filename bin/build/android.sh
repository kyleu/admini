...
##
## Outputs:
##   - build/dist/admini_<version>_android_aar.zip
##   - build/dist/admini_<version>_android_apk.zip
...
GOARCH=arm64 time gomobile bind -o build/dist/mobile_android_arm64/admini.aar -target=android -androidapi 21 admini.dev/admini/app/cmd
...
echo "Output written to [./build/dist/admini_${TGT}_android_aar.zip] and [./build/dist/admini_${TGT}_android_apk.zip]"
