...
##
## Outputs:
##   - build/dist/admini_<version>_ios_framework.zip
##   - build/dist/admini_<version>_ios_app.zip
...
cd "$dir/../.."
echo "Output written to ./build/dist/admini_${TGT}_ios_framework.zip and ./build/dist/admini_${TGT}_ios_app.zip"
