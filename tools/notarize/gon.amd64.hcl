...
//notarize {
//  path = "./build/dist/admini_0.1.21_macos_x86_64_desktop.dmg"
//  bundle_id = "com.kyleu.admini"
//}
...
dmg {
  output_path = "./build/dist/admini_0.1.21_macos_x86_64.dmg"
  volume_name = "Admini"
}

zip {
  output_path = "./build/dist/admini_0.1.21_macos_x86_64_notarized.zip"
}
