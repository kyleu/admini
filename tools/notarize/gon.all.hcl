...
notarize {
  path = "./build/dist/admini_0.3.2_darwin_all_desktop.dmg"
  bundle_id = "com.kyleu.admini"
}
...
dmg {
  output_path = "./build/dist/admini_0.3.2_darwin_all.dmg"
  volume_name = "Admini"
}

zip {
  output_path = "./build/dist/admini_0.3.2_darwin_all_notarized.zip"
}
