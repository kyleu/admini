...
//line queries/qpostgres/ListTables.sql:1
package qpostgres
...
where
  ...
  `)
//line queries/qpostgres/ListTables.sql:24
	if schema != "" {
//line queries/qpostgres/ListTables.sql:24
		qw422016.N().S(`
  and n.nspname = '`)
//line queries/qpostgres/ListTables.sql:25
		qw422016.E().S(schema)
//line queries/qpostgres/ListTables.sql:25
		qw422016.N().S(`'
  `)
//line queries/qpostgres/ListTables.sql:26
	}
//line queries/qpostgres/ListTables.sql:26
	qw422016.N().S(`
order by
...
;
-- `)
//line queries/qpostgres/ListTables.sql:31
}
